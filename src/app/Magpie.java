...
public class Magpie
{
	...
	public String getResponse(String statement)
	{
		...
		else if (findKeyword(statement, "Horse") >= 0
        || findKeyword(statement, "animal") >= 0
        || findKeyword(statement, "herd") >= 0
        || findKeyword(statement, "wild") >= 0)
        {
        response = "Tell me more about your horse.";
		}
		else if (findKeyword(statement, "Brynn") >= 0
        || findKeyword(statement, "student") >= 0
        || findKeyword(statement, "girl") >= 0
		...
		response = "Say something please.";
			...
			String objectOfDesire = statement.substring(startingPosition);
			response = "Would you really be happy if you had " + objectOfDesire + "?";
